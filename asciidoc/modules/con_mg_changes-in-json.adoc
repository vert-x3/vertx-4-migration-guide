...
The helper functions {toBase64} and {toBase64Url} enable only JSON migrations. If you use automatic object mapping from JSON
to a {Java} POJO in your applications, then you must create a custom object mapper to convert the Base64
string to Base64URL.
