...
The web client is available from {VertX} 3.4.0. There is no change in web client in {VertX} {4}.
...
The following example shows an example using HTTP client in {VertX} {3x} releases:
...
The following example shows how to migrate the example to web client in {VertX} {3x} and {VertX} {4} releases:
