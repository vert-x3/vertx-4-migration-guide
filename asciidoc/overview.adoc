...
Replacing the usage of deprecated APIs is an early part of an overall migration plan, it can be achieved
early and has other benefits such as using a better or more robust API.
